...
public:
  ...
  inline bool getE2eBlended() const;
...
public:
  ...
  inline bool getE2eBlended();
  inline void setE2eBlended(bool value);
...
inline bool LongitudinalPlanSP::Reader::getE2eBlended() const {
  return _reader.getDataField<bool>(
      ::capnp::bounded<163>() * ::capnp::ELEMENTS);
}

inline bool LongitudinalPlanSP::Builder::getE2eBlended() {
  return _builder.getDataField<bool>(
      ::capnp::bounded<163>() * ::capnp::ELEMENTS);
}
inline void LongitudinalPlanSP::Builder::setE2eBlended(bool value) {
  _builder.setDataField<bool>(
