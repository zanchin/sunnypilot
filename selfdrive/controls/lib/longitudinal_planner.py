...
class LongitudinalPlanner:
  ...
  def update(self, sm):
    ...
    #if not reset_state:
     # reset_state = self.dynamic_experimental_controller.has_changed()
  ...
  def publish(self, sm, pm):
    ...
    longitudinalPlanSP.e2eBlended = self.mpc.mode == 'blended'
    longitudinalPlanSP.e2eStatus = self.dynamic_experimental_controller.is_enabled()
